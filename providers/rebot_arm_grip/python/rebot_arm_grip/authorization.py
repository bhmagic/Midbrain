...
class AuthorizationError(PermissionError):
    """A Grip Skill assertion is missing, stale, invalid, or mismatched."""
...
def sign_assertion(payload: dict[str, Any], secret: str) -> str:
    if len(secret.encode("utf-8")) < 32:
        raise AuthorizationError("Grip Skill signing secret must be at least 32 bytes")
...
def verify_assertion(
    ...
    *,
    ...
    for name in ("assertion_id", "nonce"):
