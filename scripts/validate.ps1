...
if (-not $SkipPython) {
    ...
    $pythonPathEntries = @(
        ...
        (Join-Path $workspace "providers\rebot_arm_grip\python"),
        (Join-Path $workspace "skills\contact_work_runtime\python"),
        (Join-Path $workspace "skills\grip_work_runtime\python"),
        (Join-Path $workspace "skills\grip\python"),
        (Join-Path $workspace "skills\slicing\python"),
        (Join-Path $workspace "skills\grip-object\python"),
        (Join-Path $workspace "skills\move-carried-object\python"),
        (Join-Path $workspace "skills\let-go\python"),
        (Join-Path $workspace "skills\lay-flat\python"),
        (Join-Path $workspace "skills\limited-graph\python"),
    ...
    try {
        ...
        Invoke-Checked -FilePath $python -Arguments @(
            ...
            (Join-Path $workspace "providers\rebot_arm_grip\python\tests"),
            (Join-Path $workspace "skills\contact_work_runtime\python\tests"),
            (Join-Path $workspace "skills\grip_work_runtime\python\tests"),
            (Join-Path $workspace "skills\grip\python\tests"),
            (Join-Path $workspace "skills\slicing\python\tests"),
            (Join-Path $workspace "skills\grip-object\python\tests"),
            (Join-Path $workspace "skills\let-go\python\tests"),
            (Join-Path $workspace "skills\lay-flat\python\tests"),
            (Join-Path $workspace "skills\limited-graph\python\tests"),
